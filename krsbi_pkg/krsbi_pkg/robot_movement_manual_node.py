...
from krsbi_interfaces.msg import Wheel, DribbleModule, KickerSetting, DribbleSetting, NavigationSetting, RobotStatus, ControlOutput, Coordinate, RobotMode, SetPoint, BallPositionBasedOnCamera
...
class RobotMovementManualNode(Node):
    def __init__(self):
        ...
        self.create_subscription(KickerSetting, '/ui/KickerSetting', self.kickerSettingCallback, 10)
